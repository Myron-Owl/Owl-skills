...
S01,C01,扩张是否提高防守压力,保持难度与时间相近,扩建边界,敌人路径或威胁范围变化,不扩张时压力同样增长,P0,no,,
```
...
V001,00:00:00.000,00:00:02.400,你每扩一块地...,C01,扩张前后同屏对比,显示边界扩大与威胁变化,P0,2.4,needed,,,,
```
